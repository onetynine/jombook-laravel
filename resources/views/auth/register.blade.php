    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="role" class="block mt-1 w-full" type="hidden" name="default_role" value="customer"
                    required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="email" class="block mt-1 w-full" type="date" name="date_of_birth" :value="old('date_of_birth')"
