<x-guest-layout>
    {{-- <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            @csrf
            <input type="hidden" name="login_type" value="merchant">
          ...
          <div class="mx-auto w-full max-w-sm lg:w-96">
            <div>
              ...
              <p class="mt-2 text-sm leading-6 text-gray-500">
                Not a merchant yet?
                <a href="{{ route('merchant.register') }}" class="font-semibold text-indigo-600 hover:text-indigo-500">Register Now</a>
              </p>
            </div>
            ...
            <div class="mt-10">
              <div>
                <form method="POST" class="space-y-3" action="{{ route('login') }}">
                    @csrf
            <input type="hidden" name="login_type" value="merchant"><div>
